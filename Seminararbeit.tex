...
\input{sections/03_features}
\input{sections/04_0_algorithms}
\input{sections/04_1_decisiontree} %TODO
\input{sections/04_2_svm}
\input{sections/04_3_knearest}
\input{sections/04_4_kmean} %TODO
\input{sections/05_evaluation} %TODO
\input{sections/06_fazit} %TODO
